...
public class DatabaseExample : MonoBehaviour {
	...
	bool CreateTable()
	{
		...
		if (db.Exists) {
			...
			schema.AddField("ID", SQLiteDB.DB_DataType.DB_INT, 0, false, true, true);
			//schema.AddField("ID_Channel", SQLiteDB.DB_DataType.DB_INT, 11, true , false, true);
			//schema.AddField("OtherName", SQLiteDB.DB_DataType.DB_VARCHAR, 100, true , false, true);
			//schema.AddField("Discuss", SQLiteDB.DB_DataType.DB_TEXT, 100  , false, false, false);
			//schema.AddField("Profil", SQLiteDB.DB_DataType.DB_TEXT, 100, false, false, false);
			//schema.AddField("HaveNewMsg", SQLiteDB.DB_DataType.DB_INT, 1, false, false, false);
			bool created = db.CreateTable(schema);
			Debug.Log(created);
